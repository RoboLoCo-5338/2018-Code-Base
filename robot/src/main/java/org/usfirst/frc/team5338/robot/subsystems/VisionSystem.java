...
public class VisionSystem extends Subsystem
{
	...
	public void track()
	{
		...
		// SmartDashboard.putNumber("X Coordinate",
		// this.table.getEntry("XCoordinate").getDouble(-1.0));
		// SmartDashboard.putNumber("Y Coordinate",
		// this.table.getEntry("YCoordinate").getDouble(-1.0));
		// SmartDashboard.putNumber("Width",
		// this.table.getEntry("Width").getDouble(0.0));
