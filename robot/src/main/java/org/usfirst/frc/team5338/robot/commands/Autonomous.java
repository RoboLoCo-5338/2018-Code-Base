...
public class Autonomous extends CommandGroup
{
	...
	private final StraightDrive nineFootDrive = new StraightDrive(108.0);
	
	public Autonomous()
	{
		// final MatchData.OwnedSide side =
		// MatchData.getOwnedSide(MatchData.GameFeature.SWITCH_NEAR);
